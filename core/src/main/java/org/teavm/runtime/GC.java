...
public final class GC {
    ...
    private static void collectGarbageImpl() {
    ...
    private static void resizeHeapIfNecessary() {
        long availableBytes = availableBytes();
        long occupiedMemory = availableBytes - freeMemory;
        if (occupiedMemory > availableBytes / 2) {
            long newSize = (availableBytes - freeMemory) * 2;
